        ...
        <div class="max-w-[1200px] w-full">
            <div class="max-w-[600px] mx-auto px-4">
                ...
                <div class="flex flex-wrap justify-center gap-4 sm:gap-8 mt-6 sm:mt-8">
                    ...
                    <a href="https://www.linkedin.com/in/sir-victor-aquino" class="text-[#d1cb95] no-underline text-base sm:text-lg transition-colors duration-300 hover:text-[#40985e]">LinkedIn</a>
                    <a href="https://github.com/CS-Aki" class="text-[#d1cb95] no-underline text-base sm:text-lg transition-colors duration-300 hover:text-[#40985e]">GitHub</a>
                    <a href="https://www.facebook.com/sirvictor.aquino" class="text-[#d1cb95] no-underline text-base sm:text-lg transition-colors duration-300 hover:text-[#40985e]">Facebook</a>
                </div>
            </div>
        </div>
    </section>
